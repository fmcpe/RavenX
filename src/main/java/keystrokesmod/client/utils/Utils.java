...
public class Utils {
    ...
    public static class Client {
        ...
        public static int purpledraw(int delay) {
            int r = getColorBetween(137, 137, delay);
            int g = getColorBetween(82, 82, delay);
            int b = getColorBetween(197, 197, delay);
            return new Color(r, g, b).getRGB();
        }

        public static int reddraw(int delay) {
            int r = getColorBetween(222, 250, delay);
            int g = getColorBetween(0, 255, delay);
            int b = getColorBetween(0, 255, delay);
            return new Color(r, g, b).getRGB();
        }
        public static int customDraw(int delay) {
            ...
            return new Color(211, 174, 239).getRGB();
        }
