...
public class KillAura extends Module {
    ...
    private final TickSetting fixMovement,legitAttack,visuals,customRPS,weaponOnly,sinhud;
    public static ComboSetting<BlockMode> blockMode;
    public static ComboSetting<RotMode> rotMode;
    /**
     * @Author Cosmic-SC
     * @Since 10/6/2023
     * @CodeQuality GOOD.
    ...
    public KillAura() {
        ...
        this.registerSetting(rotMode = new ComboSetting("Rotation mode", RotMode.vanilla));
        ...
        this.registerSetting(sinhud = new TickSetting("Random",true));
