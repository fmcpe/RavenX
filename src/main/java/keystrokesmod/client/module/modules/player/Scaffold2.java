...
public class Scaffold2 extends Module {
    ...
    public Scaffold2() {
        super("Scaffold2", ModuleCategory.scaffold);
        this.registerSetting(ds = new DescriptionSetting("Fuck"));
        this.registerSetting(c = new SliderSetting("delay", 8.0D, -2.0D, 30.0D, 1.0D));
